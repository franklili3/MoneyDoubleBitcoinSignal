...
def update(JSoutput):
    ...
    def get_upper_lower_price_client1(frequency = 'weekly'):
    ...
    if is_pc:
        data1 = get_upper_lower_price_client1(frequency='weekly')
    elif is_mobile or is_tablet:
        data1 = get_upper_lower_price_client1(frequency='monthly') 
