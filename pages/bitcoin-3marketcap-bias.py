...
def get_marketcap_bias(frequency='weekly'):
    ...
    if response1_json['token']:
        ...
        if frequency == 'monthly':
            query_predicted_marketcap_log = "?filter=(day_of_month=1)&&fields=date,marketcap_log,marketcap_bias&&perPage=500&&page=1"# + str(i)&&page=50&&perPage=100&&sort=date&&skipTotal=1response1_json
